...
def main():
    ...
    base_args = "pip install rank_bm25 nltk && python -m nltk.downloader punkt && python -m nltk.downloader stopwords && git clone https://$GIT_TOKEN@github.com/EdinburghClinicalNLP/semeval_nli4ct.git --branch fine-tuning-fix && cd semeval_nli4ct && git clone https://huggingface.co/datasets/aryopg/nli4ct_practice data && "
