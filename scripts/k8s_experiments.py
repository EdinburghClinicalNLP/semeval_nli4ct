...
def main():
    ...
    base_args = f"pip uninstall huggingface_hub && pip install huggingface_hub && git clone https://$GIT_TOKEN@github.com/EdinburghClinicalNLP/semeval_nli4ct.git --branch {args.git_branch} && cd semeval_nli4ct && huggingface-cli download aryopg/nli4ct_practice --repo-type dataset --local-dir data --token $HF_DOWNLOAD_TOKEN --quiet && "
